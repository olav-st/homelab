...
data "talos_machine_configuration" "this" {
  ...
  talos_version      = "v1.13.5" # renovate: github-releases=siderolabs/talos
  kubernetes_version = "v1.36.2" # renovate: github-releases=kubernetes/kubernetes
...
resource "talos_machine" "this" {
  ...
  image                 = "factory.talos.dev/metal-installer/5fad2b86ebfc72aaaf4ebc31cc5c36642af6f8557f35132be6d86196058790a6:v1.13.5" # renovate: github-releases=siderolabs/talos
}
